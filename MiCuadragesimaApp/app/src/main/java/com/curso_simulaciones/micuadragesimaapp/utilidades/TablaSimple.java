...
public class TablaSimple extends LinearLayout {
    ...
    private String etiquetaZ="z";
    private float x,y,z;
    private int colorColumna1= Color.YELLOW;
    private int colorColumna2=Color.WHITE;
     ...
     * @param etiquetaY
     */
    public void setEtiquetaColumnas(String etiquetaX, String etiquetaY, String etiquetaZ){

        this.etiquetaX=etiquetaX;
        this.etiquetaY=etiquetaY;
        this.etiquetaZ=etiquetaZ;
     ...
     * @param y
     */
    public void enviarDatos(float x, float y, float z){
     ...
     * @param colorColumna3
     */
    public void setColorColumnas(int colorColumna1, int colorColumna2,int colorColumna3, int colorColumna4){
    ...
    private void incrementarFila() {
        ...
        TableRow.LayoutParams layoutTexto = new TableRow.LayoutParams((int)(0.3*dimensionReferencia), TableRow.LayoutParams.WRAP_CONTENT);
        ...
        //Columna 4
        TextView textValorZ = new TextView(context);
        textValorZ.setTextSize(TypedValue.COMPLEX_UNIT_SP, tamanoLetraResolucionIncluida);
        textValorZ.setLayoutParams(layoutTexto);

        if(contador==0)
        {
            textValorZ.setText(etiquetaZ);

        } else {

            textValorZ.setText("" + z);

        }

        textValorZ.setTextSize(tamanoLetraResolucionIncluida);
        textValorZ.setTextColor(colorColumna4);
        textValorZ.setGravity(Gravity.CENTER_HORIZONTAL);
