...
import com.curso_simulaciones.micuadragesimasegundaapp.utilidades.Luxometro;
...
public class ActividadComoClientePubMQTT extends Activity implements Runnable  {
    ...
    private float medida_gaussimetro, medida_luxometro;
    private int componente_campo;
    ...
    private void crearElementosGUI() {
        ...
        gaussimetro.setRango(0, 50);//????
        gaussimetro.setAngulosSectores(50, 100, 100);
        gaussimetro.setColorFranjaDinámica(Color.rgb(255,0,0));
        gaussimetro.captarSensor(this);
        ...
        luxometro.setColorFranjaDinámica(Color.rgb(255,0,0));
        luxometro.setBackgroundColor(Color.BLACK);
        ...
        textviewRol.setBackgroundColor(Color.rgb(50, 50, 50));
        textviewRol.setText("PUB");
        textviewRol.setTextColor(Color.rgb(4, 160, 240));
        ...
        textviewAviso.setBackgroundColor(Color.rgb(50, 50, 50));
        textviewAviso.setTextColor(Color.rgb(4, 160, 240));
        ...
        botonConectar.getBackground().setColorFilter(Color.rgb(4, 160, 240), PorterDuff.Mode.MULTIPLY);
    ...
    private LinearLayout crearGUI() {
        ...
        linearLayoutColumnaDosDerecha.setBackgroundColor(Color.BLACK);
        ...
        linearLayoutColumnaDosIzquierda.addView(gaussimetro);
    ...
    private String getStringJSON(){
        ...
        try {
            ...
            medida_gaussimetro = gaussimetro.getMedida();
            medida_luxometro = luxometro.getMedida();
            obj.put("componente", componente_campo);
            obj.put("valor_acelerometro", medida_gaussimetro);
