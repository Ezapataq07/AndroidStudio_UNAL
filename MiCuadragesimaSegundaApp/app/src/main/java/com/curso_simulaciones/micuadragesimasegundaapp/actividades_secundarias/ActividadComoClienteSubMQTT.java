...
public class ActividadComoClienteSubMQTT extends Activity implements Runnable {
    ...
    public void convertirStrigJson(String datoString) {
        ...
        try {
            ...
            gaussimetro.setComponenteCampo(componente_aceleracion);
        ...
        try {
            ...
            gaussimetro.setMedida(medida_aclerometro);
            gaussimetro.cambiarEscala(medida_aclerometro);
