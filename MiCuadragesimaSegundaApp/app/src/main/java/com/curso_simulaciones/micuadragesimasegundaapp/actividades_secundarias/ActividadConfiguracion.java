...
public class ActividadConfiguracion extends Activity {
    ...
    private LinearLayout crearGUI() {
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_cinco_primeras_filas_I = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        parametros_pegado_elementos_cinco_primeras_filas_I .weight = 1.0f;
        LinearLayout.LayoutParams parametros_pegado_elementos_cinco_primeras_filas_D = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametros_pegado_elemento_quinta_fila = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
