package com.curso_simulaciones.micuadragesimaterceraapp.utilidades;
...
public class TableroColor extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("Copyright 2022 para Diego L. Aristizábal Ramírez", indent,alto-0.3f*indent, pincel);
