package com.curso_simulaciones.midecimaquintaapplogo;
...
import com.curso_simulaciones.midecimaquintaapplogo.actividades_secundarias.ActividadSecundariaMiDecimaQuintaAppLogo;
import com.curso_simulaciones.midecimaquintaapplogo.datos.AlmacenDatosRAM;

public class ActividadPrincipalMiDecimaQuintaAppLogo extends Activity {
    ...
    private void lanzarAplicacionSecundaria() {
        ...
        Intent intent = new Intent(this, ActividadSecundariaMiDecimaQuintaAppLogo.class);
