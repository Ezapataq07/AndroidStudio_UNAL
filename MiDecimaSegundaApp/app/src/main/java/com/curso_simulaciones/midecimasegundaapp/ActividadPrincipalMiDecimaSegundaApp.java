package com.curso_simulaciones.midecimasegundaapp;
...
import com.curso_simulaciones.midecimasegundaapp.objetos_laboratorio.CuerpoRectangular;
import com.curso_simulaciones.midecimasegundaapp.objetos_laboratorio.CuerpoRigido;
import com.curso_simulaciones.midecimasegundaapp.objetos_laboratorio.Polea;
import com.curso_simulaciones.midecimasegundaapp.objetos_laboratorio.Rueda;
import com.curso_simulaciones.midecimasegundaapp.vista.CR;
import com.curso_simulaciones.midecimasegundaapp.vista.Pizarra;
...
public class ActividadPrincipalMiDecimaSegundaApp extends Activity implements Runnable {
    ...
    private CuerpoRigido[] cuerpos= new CuerpoRigido[10];
    ...
    */
    private void crearObjetosLaboratorio() {
        ...
        /* En MiDecimaPrimeraApp estaban estas líneas
        de código, pero aquí no es posible obtener
        objetos directamente de CuerpoRigido
        ya que es una clase abstracta

        //cuerpo rígido (solo dibuja la letra R
        float x_0 = CR.pcApxX(90);
        float y_0 = CR.pcApxY(90);
        cuerpos[0] = new CuerpoRigido(x_0,y_0);
        cuerpos[0].setColor(Color.GREEN);
         */
        ...
        //agregar al arreglo de cuerpos rígidos
        cuerpos[0] = polea_1;
