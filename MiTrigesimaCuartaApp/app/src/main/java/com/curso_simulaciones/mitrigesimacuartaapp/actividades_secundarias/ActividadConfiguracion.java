...
public class ActividadConfiguracion extends Activity {
    ...
    private LinearLayout crearGUI() {
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_fila_uno = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_fila_dos = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_fila_tres_izquierda = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_fila_tres_derecha = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_fila_cuatro_izquierda = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametros_pegado_elementos_fila_cuatro_derecha = new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT);
