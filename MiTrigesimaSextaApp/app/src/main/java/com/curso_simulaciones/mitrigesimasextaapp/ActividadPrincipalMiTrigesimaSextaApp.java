...
public class ActividadPrincipalMiTrigesimaSextaApp extends Activity {
    ...
    //prueba permisos bluetooth para Android 12
    ...
    private void verificacionPermisos() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.S) {
            ...
            if (hasReadWritePermission != PackageManager.PERMISSION_GRANTED) {
                ...
                ActivityCompat.requestPermissions(ActividadPrincipalMiTrigesimaSextaApp.this,
                        new String[]{
        ...
        switch (requestCode) {
            case 100:
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ActividadPrincipalMiTrigesimaSextaApp.this, "Permiso denegado.", Toast.LENGTH_SHORT).show();
                    finish();
                }
                return;
        }
