...
import com.curso_simulaciones.explorador.vista.FolderLayout;
import com.curso_simulaciones.explorador.vista.IFolderItemListener;
...
public class ActividadExploradoraArchivos extends Activity implements IFolderItemListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FolderLayout folder = new FolderLayout(this, tamanoLetraResolucionIncluida, "almacen_mis_datos/luxometro/");
