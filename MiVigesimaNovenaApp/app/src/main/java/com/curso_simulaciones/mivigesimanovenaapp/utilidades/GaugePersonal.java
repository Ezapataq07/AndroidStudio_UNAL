...
public class GaugePersonal extends View {
    ...
    //color del marco
    private int colorFondoTacometro = Color.rgb(27,27,27);
    ...
    private int colorLineas = Color.rgb(4,160,240);
     ...
     */
    public GaugePersonal(Context context) {
    ...
    private void setNumDivisions(int numDivisions){
...
//            canvas.drawText(numero, posicionXNumero, posicionYNumero, pincel);
        ...
        */
        ...
        pincel.setTextAlign(Paint.Align.CENTER);
        pincel.setTextSize(0.15f*largo);
