package com.curso_simulaciones.pruebaterceraapp;
...
import com.curso_simulaciones.pruebaterceraapp.componentes.Pizarra;

public class ActividadPrincipalPruebaTerceraApp extends Activity {
    ...
    private LinearLayout crearGui() {
        ...
        linear_principal.setBackgroundColor(Color.rgb(30, 50, 250));
